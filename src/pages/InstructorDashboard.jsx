        ...
        >
          ...
          <div className="relative p-10 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-5xl font-black text-white mb-2">Rebbe's Dashboard</h1>
                <p className="text-slate-300 text-lg" dir="rtl">שלום ומברך, {user?.full_name}</p>
                <p className="text-amber-400 text-sm font-semibold mt-1">Teaching the Torah of Breslov with Love</p>
              </div>
